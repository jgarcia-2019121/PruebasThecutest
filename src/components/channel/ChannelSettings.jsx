...
import { valideteUsername, usernameValidationMessage, titleValidationMessage, avatarValidationMessage, descriptionValidationMessage, validateTitle, validateAvatarUrl, validateDescription } from '../../shared/validators/validator.js'
...
export const ChannelSettings = ({settings, saveSettings}) => {
  ...
  const [formState, setFormState] = useState({
    ...
    username: {
      isValid: valideteUsername(settings.username),
      showError: false,
